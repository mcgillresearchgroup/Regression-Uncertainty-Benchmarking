...
from Benchmarking_Results.utils import (
    parse_args, 
    load_dataset, 
    save_results, 
    print_metrics, 
...
from Benchmarking_Results.hyperparameter_optimization import (
    initialize_model, 
...
def main():
    ...
    if args.optimize:
        ...
        print("Error: neither --optimize nor --use-best was given; no hyperparameters to train with.")
        sys.exit(1)
    ...
    mean_pred, var_pred, y_true, fold_id = model_wrapper.cross_validate(
    ...
    filename, metrics, nll = save_results(
        ...
        hyperparameters=hp, train_percent=args.train_percent, fold_id=fold_id
    )
